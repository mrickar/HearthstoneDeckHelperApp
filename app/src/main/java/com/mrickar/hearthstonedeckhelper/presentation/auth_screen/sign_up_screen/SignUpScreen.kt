...
//    val state=remember{ mutableStateOf(SignInState())}
    ...
    Column(modifier= Modifier
        ...
        Text(text="Sign Up", style = MaterialTheme.typography.body1, color = Color.White, fontStyle = FontStyle.Italic)
        AuthTextField(
        ...
        AuthTextField(
            modifier=textFieldModifier,
            value = state.value.rePassword,
            onValueChanged = {
                viewModel.setRePassword(it)
            },
            keyboardType = KeyboardType.Password,
